                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String typedNote = note.getText().toString();
                            ...
                            else
                            {
                                ...
                                listener.applyTexts(typedname, typedCategory, typedDate, typedAamount, typedNote);
                            }
...
note  = view.findViewById(R.id.noteEnter);
    ...
    public interface DialogListener{
        void applyTexts(String typedname, String typedCategory, String typedDate, double typedAmount, String typedNote);
    }
