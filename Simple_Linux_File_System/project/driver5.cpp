...
int main()
{
	...
	cout << "rv from createFile /o/o/o/a is " << r << tabs3 << (r == 0 ? " Correct" : " fail") << endl;
	f1 = c2->myFS->openFile(const_cast<char*>("/o/o/o/a"), 8, 'w', -1);
	cout << "rv from openFile /o/o/o/a is " << f1 << tabs4 << (f1 > 0 ? " Correct" : " fail") << endl;
	r = c2->myFS->writeFile(f1, buf3, 600);
	cout << "rv from writeFile /o/o/o/a is " << r << tabs3 << (r == 600 ? " Correct write 600 Fs" : " fail") << endl;
	r = c2->myFS->writeFile(f1, buf4, 600);
	cout << "rv from writeFile /o/o/o/a is " << r << tabs3 << (r == 600 ? " Correct write 600 Is" : " fail") << endl;
	r = c2->myFS->closeFile(f1);
	cout << "rv from closeFile /o/o/o/a is " << r << tabs4 << (r == 0 ? " Correct" : " fail") << endl;

	r = c2->myFS->createFile(const_cast<char*>("/o/o/o/b"), 8);
	cout << "rv from createFile /o/o/o/b is " << r << tabs3 << (r == 0 ? " Correct" : " fail") << endl;
	f1 = c2->myFS->openFile(const_cast<char*>("/o/o/o/b"), 8, 'w', -1);
	cout << "rv from openFile /o/o/o/b is " << f1 << tabs4 << (f1 > 0 ? " Correct" : " fail") << endl;

	r = c2->myFS->writeFile(f1, buf4, 600);
	cout << "rv from writeFile is " << r << tabs4 << (r == 600 ? " Correct write 600 Is" : " fail") << endl;
	r = c2->myFS->appendFile(f1, buf2, 64);
	cout << "rv from appendFile /o/o/o/b is " << r << tabs3 << (r == 64 ? " Correct write 64 Ts" : " fail") << endl;
	r = c2->myFS->appendFile(f1, buf3, 64);
	cout << "rv from appendFile /o/o/o/b is " << r << tabs3 << (r == 64 ? " Correct write 64 Fs" : " fail") << endl;
	r = c2->myFS->appendFile(f1, buf4, 64);
	cout << "rv from appendFile /o/o/o/b is " << r << tabs3 << (r == 64 ? " Correct write 64 Is" : " fail") << endl;
	r = c2->myFS->closeFile(f1);
	cout << "rv from closeFile /o/o/o/b is " << r << tabs4 << (r == 0 ? " Correct" : " fail") << endl;

	r = c2->myFS->createFile(const_cast<char*>("/o/o/o/c"), 8);
	cout << "rv from createFile /o/o/o/c is " << r << tabs3 << (r == 0 ? " Correct" : " fail") << endl;
	f1 = c2->myFS->openFile(const_cast<char*>("/o/o/o/c"), 8, 'w', -1);
	cout << "rv from /o/o/o/c openFile is " << f1 << tabs4 << (f1 > 0 ? " Correct" : " fail") << endl;
	r = c2->myFS->writeFile(f1, buf2, 64);
	cout << "rv from writeFile /o/o/o/c is " << r << tabs3 << (r == 64 ? " Correct write 64 Ts" : " fail") << endl;
	r = c2->myFS->writeFile(f1, buf3, 64);
	cout << "rv from writeFile /o/o/o/c is " << r << tabs3 << (r == 64 ? " Correct write 64 Fs" : " fail") << endl;
	r = c2->myFS->writeFile(f1, buf4, 64);
	cout << "rv from writeFile /o/o/o/c is " << r << tabs3 << (r == -3 ? " Correct fs2 is full" : " fail") << endl;
	r = c2->myFS->appendFile(f1, buf4, 64);
	cout << "rv from appendFile /o/o/o/c is " << r << tabs3 << (r == -3 ? " Correct fs2 is full" : " fail") << endl;
	r = c2->myFS->closeFile(f1);
	cout << "rv from closeFile /o/o/o/c is " << r << tabs4 << (r == 0 ? " Correct" : " fail") << endl;
